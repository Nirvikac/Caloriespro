...
class CaloriesAnalysis extends StatefulWidget {
  const CaloriesAnalysis({super.key, required this.caloriesGoal});
  final double caloriesGoal;

  @override
  State<CaloriesAnalysis> createState() => _CaloriesAnalysisState();
}

class _CaloriesAnalysisState extends State<CaloriesAnalysis> {
        ...
        children: [
          ...
          Positioned(
            top:
                tooltipHeight +
                barAreaHeight -
                (widget.caloriesGoal / maxVal * barAreaHeight),
            left: 0,
            right: 0,
            height: 1,
            child: Row(
              ...
              children: [
                ...
                Text(
                  '${(widget.caloriesGoal / 1000).toStringAsFixed(0)}k',
                  style: TextStyle(
                    fontSize: 9,
                    fontWeight: FontWeight.w600,
          ...
          Row(
            ...
            children: List.generate(_dayLabels.length, (i) {
              ...
              } else if (val > widget.caloriesGoal) {
                barColor = _coral;
              } else {
